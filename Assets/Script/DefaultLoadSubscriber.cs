...
{
    public class DefaultLoadSubscriber : UnitySubscriber<MessageTypes.Sensor.Joy>
    {
        public string configName = "Default Device";
        public JoyButtonWriter[] joyButtonWriters;
        public JoyAxisWriter[] joyAxisWriters;
        public double[] hapticForce = new double[3] { 0, 0, 0 };
        public double[] hapticTorque = new double[3] { 0, 0, 0 };
